...
?>
          ...
          <form action="./authentication.php"method="POST"class="sign-in-form">
            ...
            <div class="input-field">
              ...
              <input type="text"
               ...
               name="log_email"
               onkeyup=" return logMail();"
               id="logmail" />
            </div>
            <span id="log_email_error" ></span>
            <div class="input-field">
              <i class="fas fa-lock"></i>
              <input type="password"
               placeholder="Password"
               onkeyup="return passWord();"
               name="log_pwd"
               id="pwd" />
            </div>
            <span id="logsub_error"></span>
            <input type="submit" 
            value="Login" 
            class="btn solid"
            name="log_sub"
    ...
    <?php
      ...
      ?>
      <script>
       $('#pwd').tooltip({'trigger':'focus', 'title': 'Password tooltip'});
      </script>
