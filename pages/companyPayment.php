            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <?php
                    $res = mysqli_query($con, "SELECT register.username,payment.id,booking.vehicleAllocated as vehicleId ,payment.booking_id as booking_id,payment.company as driver_payment FROM
