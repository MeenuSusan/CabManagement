          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Manage Driver Cab Request</h3>
              </div>
              ...
              <div class="card-body">
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      <?php
                      $i = 0;
                      $selectRequestedCabSql = "SELECT id,vehicle_id,status,driver_id FROM vehicle_request WHERE status = 0";
                      ...
                      if (mysqli_num_rows($selectRequestedCabResult) > 0) {
                        ...
                        while ($row3 = mysqli_fetch_assoc($selectRequestedCabResult)) {
                          ...
                          if (mysqli_num_rows($result) > 0) {
                            ...
                            <td>
                              <form action="cabRequestAction.php" method="post">
                                <input type="hidden" name="requestedCabVehicleId" value="' . $requestedCabVehicleId . '">
                                <input type="hidden" name="requestedCabDriverId" value="' . $requestedCabDriverId . '">
                                <input type="hidden" name="currentVehicleId" value="' . $currentVehicleId . '">
                                <button id="acceptBtn" name="acceptBtn"  type="submit" value="'.$requestId.'" class="btn btn-success">Accept</button>  
                                <button id="rejectBtn" name="rejectBtn" type="submit" value="'.$requestId.'" class="btn btn-danger">Reject</button>
                              </form> 
                            </td>  
